...
The current v3.5.1 suite defines 88 real integration cases and remains a release-candidate test definition until it is run on a disposable real Proxmox host with zero failures and zero protected-state anomalies.
