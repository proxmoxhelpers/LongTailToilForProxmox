...
[Back to helper list](../README.md) · [View script](../show-thin-snapshot-tree.sh) · [Raw usage](./show-thin-snapshot-tree.sh.usage)
...
```sh
./show-thin-snapshot-tree.sh --help
```

<!-- BEGIN LIVE HELP -->
```text
show-thin-snapshot-tree.sh 3.7.1 (project 3.7.1)
...
The same output is stored verbatim in [`show-thin-snapshot-tree.sh.usage`](./show-thin-snapshot-tree.sh.usage) and is checked byte-for-byte by the static suite.
