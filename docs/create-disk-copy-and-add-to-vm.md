...
[Back to helper list](../README.md) · [View script](../create-disk-copy-and-add-to-vm.sh) · [Raw usage](./create-disk-copy-and-add-to-vm.sh.usage)
...
```sh
./create-disk-copy-and-add-to-vm.sh --help
```
...
EXAMPLES
  create-disk-copy-and-add-to-vm.sh /dev/pve/vm-123-disk-0 456 sata boot dryrun
  create-disk-copy-and-add-to-vm.sh 123 sata0 456 virtio0 restart boot dryrun
