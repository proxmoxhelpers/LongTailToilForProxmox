...
[Back to helper list](../README.md) · [View script](../resize-vm-disk.sh) · [Raw usage](./resize-vm-disk.sh.usage)
...
```sh
./resize-vm-disk.sh --help
```

<!-- BEGIN LIVE HELP -->
```text
resize-vm-disk.sh 3.7.1 (project 3.7.1)
...
The same output is stored verbatim in [`resize-vm-disk.sh.usage`](./resize-vm-disk.sh.usage) and is checked byte-for-byte by the static suite.
