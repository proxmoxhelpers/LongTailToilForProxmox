...
USAGE
  ...
  create-disk-snapshot-and-overwrite-disk-on-vm.sh <source-lv-path> <dest-vmid> <dest-disk-N|dest-slot|dest-bus> [hot|pause|stop|restart] [delete] [boot] [dryrun]
  create-disk-snapshot-and-overwrite-disk-on-vm.sh <source-vmid> <source-disk-N|source-slot> <destination-lv-path> [hot|pause|stop|restart] [delete] [boot] [dryrun]
  create-disk-snapshot-and-overwrite-disk-on-vm.sh <source-vmid> <source-disk-N|source-slot> <dest-vmid> <dest-disk-N|dest-slot|dest-bus> [hot|pause|stop|restart] [delete] [boot] [dryrun]
