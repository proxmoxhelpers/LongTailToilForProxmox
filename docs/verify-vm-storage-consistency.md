...
[Back to helper list](../README.md) · [View script](../verify-vm-storage-consistency.sh) · [Raw usage](./verify-vm-storage-consistency.sh.usage)
...
```sh
./verify-vm-storage-consistency.sh --help
```

<!-- BEGIN LIVE HELP -->
```text
verify-vm-storage-consistency.sh 3.7.1 (project 3.7.1)
...
The same output is stored verbatim in [`verify-vm-storage-consistency.sh.usage`](./verify-vm-storage-consistency.sh.usage) and is checked byte-for-byte by the static suite.
