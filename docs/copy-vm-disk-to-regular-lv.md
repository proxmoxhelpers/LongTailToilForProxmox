...
[Back to helper list](../README.md) · [View script](../copy-vm-disk-to-regular-lv.sh) · [Raw usage](./copy-vm-disk-to-regular-lv.sh.usage)
...
```sh
./copy-vm-disk-to-regular-lv.sh --help
```

<!-- BEGIN LIVE HELP -->
```text
copy-vm-disk-to-regular-lv.sh 3.7.1 (project 3.7.1)
...
The same output is stored verbatim in [`copy-vm-disk-to-regular-lv.sh.usage`](./copy-vm-disk-to-regular-lv.sh.usage) and is checked byte-for-byte by the static suite.
